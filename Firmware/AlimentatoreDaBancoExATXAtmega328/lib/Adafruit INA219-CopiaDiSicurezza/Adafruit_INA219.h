...
public:
  ...
  bool setCalibration_vvV_aaA(float udRShunt, uint16_t udVShunt, float udCurrentMaxA, float udCurrentLSBmA, uint8_t udVMax, uint16_t BADCRes = INA219_CONFIG_BADCRES_12BIT, uint16_t SADCSamp = INA219_CONFIG_BADCRES_12BIT_8S_4260US);
